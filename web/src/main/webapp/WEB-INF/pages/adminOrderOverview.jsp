...
<div class="container">
    ...
    <div class="row">
        <div class="col col-md-4">
            <h1><spring:message code="titlePage.adminOverview"/></h1>
        </div>
        ...
        <div class="col col-md-2">
            <spring:message code="admin.orderStatus"/>
            <h1>${order.status}</h1>
        </div>
    </div>
    <br>
    <c:choose>
        ...
        <c:otherwise>
            ...
            <div class="row input-group">
                <form action="${pageContext.servletContext.contextPath}/admin/orders" class="col col-md-1">
                ...
                <form method="post"
                      action="${pageContext.servletContext.contextPath}/admin/orders/${order.secureId}/DELIVERED"
                      class="col col-md-1">
                    <button class="btn btn-outline-secondary">
                ...
                <form method="post"
                      action="${pageContext.servletContext.contextPath}/admin/orders/${order.secureId}/REJECTED"
                      class="col col-md-1">
                    <button class="btn btn-outline-secondary">
