...
public class Phone {
    ...
    public boolean equals(Object object){
        ...
        Phone comparedPhone = (Phone) object;
        boolean statement = id.equals(comparedPhone.getId()) && brand.equals(comparedPhone.getBrand()) && model.equals(comparedPhone.getModel()) &&
                price.equals(comparedPhone.getPrice()) && displaySizeInches.equals(comparedPhone.getDisplaySizeInches()) &&
                weightGr.equals(comparedPhone.getWeightGr()) && lengthMm.equals(comparedPhone.getLengthMm()) && widthMm.equals(comparedPhone.getWidthMm()) &&
                heightMm.equals(comparedPhone.getHeightMm()) && announced.equals(comparedPhone.getAnnounced()) && deviceType.equals(comparedPhone.getDeviceType()) &&
                os.equals(comparedPhone.getOs()) && displayResolution.equals(comparedPhone.getDisplayResolution()) && pixelDensity.equals(comparedPhone.getPixelDensity()) &&
                displayTechnology.equals(comparedPhone.getDisplayTechnology()) && backCameraMegapixels.equals(comparedPhone.getBackCameraMegapixels()) &&
                frontCameraMegapixels.equals(comparedPhone.getFrontCameraMegapixels()) && ramGb.equals(comparedPhone.getRamGb()) &&
                internalStorageGb.equals(comparedPhone.getInternalStorageGb()) && batteryCapacityMah.equals(comparedPhone.getBatteryCapacityMah()) &&
                talkTimeHours.equals(comparedPhone.getTalkTimeHours()) && standByTimeHours.equals(comparedPhone.getStandByTimeHours()) &&
                bluetooth.equals(comparedPhone.getBluetooth()) && positioning.equals(comparedPhone.getPositioning()) &&
                imageUrl.equals(comparedPhone.getImageUrl()) && description.equals(comparedPhone.getDescription());
    ...
    @Override
    public int hashCode(){
       return Objects.hash(id, brand, model, price, displaySizeInches, weightGr, lengthMm, widthMm, heightMm, announced, deviceType, os, displayResolution,
               pixelDensity, displayTechnology, backCameraMegapixels, frontCameraMegapixels, ramGb, internalStorageGb, batteryCapacityMah, talkTimeHours,
