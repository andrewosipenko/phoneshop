...
public class JdbcPhoneDao implements PhoneDao {
    ...
    public List<Phone> findAll(int offset, int limit, String search) {
        ...
        List<Phone> phones = jdbcTemplate.query(SqlQueryConstants.SELECT_AVAILABLE_PHONES_WITH_OFFSET
                        + offset + " LIMIT " + limit,
    ...
    public List<Phone> findAllSortedBy(int offset, int limit, String search, String sortBy, String dir) {
        ...
        List<Phone> phones = jdbcTemplate.query(
                SqlQueryConstants.SELECT_AVAILABLE_PHONES_SORTED + sortBy + " " + dir.toUpperCase()
    ...
    public Integer countAvailablePhone(String searchText) {
        ...
        return jdbcTemplate.queryForObject(SqlQueryConstants.COUNT_PHONES + SqlQueryConstants.AVAILABLE_PHONES
